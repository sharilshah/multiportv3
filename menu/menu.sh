...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e   ""
echo -e "\e[1;36m ----------------SHAHRIL VPN SERVICE-------------------\e[0m"
echo -e   ""
...
10) clear ; wget https://raw.githubusercontent.com/givpn/AutoScriptXray/master/bot%20telegram%20panel/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh ;;
11) clear ; wget -y && wget -qO- -O udp.sh "https://raw.githubusercontent.com/sharilshah/multiportv3/main/udp-custom/udp.sh" && chmod +x udp.sh && ./udp.sh ;;
x) exit ;;
